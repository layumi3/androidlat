 ...
 */
public class MarginalHacks extends AppCompatActivity implements  GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        com.google.android.gms.location.LocationListener {

    // TAG for Log.d
    private static final String TAG = MarginalHacks.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.marginal);
    ...
    public static class ErrorDialogFragment extends DialogFragment {
        ...
        public void onDismiss(DialogInterface dialog) {
            ((MarginalHacks)getActivity()).onDialogDismissed();
        }
    }
...
//        double R = 6371.0;   // km
////        double 1 = latA * Math.PI / 180;
////        double 2 = latB * Math.PI / 180;
////        double Î”Ï† = (latB - latA) * Math.PI / 180;
////        double Î”Î» = (lonB - lonA) * Math.PI / 180;
////
